...
fail_compilation/opapplyscope.d(113):        cannot pass argument `int(int* x) { global = x; return 0; }` of type `int delegate(int* x) nothrow @nogc @safe` to parameter `scope int delegate(scope int* ptr) @safe dg`
---
 */

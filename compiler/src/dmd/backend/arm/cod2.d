...
void cdnot(ref CGstate cg, ref CodeBuilder cdb,elem* e,ref regm_t pretregs)
{
    ...
    if (pretregs == 0 ||
        pretregs == mPSW)
    {
        codelem(cg,cdb,e1,pretregs,false);      // evaluate e1 for cc
        return;
    }
    ...
    if (tycomplex(e1.Ety))
    {
        ...
        */
        ...
        codelem(cg,cdb,e.E1,retregs1,1);
...
void cdcond(ref CGstate cg, ref CodeBuilder cdb,elem* e,ref regm_t pretregs)
{
    ...
    {   // Recognize (e ? e : f)
        ...
        retregs |= psw;
        if (retregs & cg.allregs)  // TODO AArch64 add support for fp registers
    ...
    const regconold = cg.regcon;
    const stackpushold = cg.stackpush;
    ...
    if (psw && jop1 != COND.ne)
    {
        ...
        fixresult(cg,cdb1,e21,retregs,pretregs);
    }
    else
        codelem(cg,cdb1,e21,retregs,false);
    ...
    if (psw && jop2 != COND.ne)
    {
        ...
        if (!retregs)
            retregs = INSTR.ALLREGS;
        codelem(cg,cdb2,e22,retregs,false);
...
void cdloglog(ref CGstate cg, ref CodeBuilder cdb,elem* e,ref regm_t pretregs)
{
    ...
    {
        regm_t retregs2 = 0;
        codelem(cg,cdb, e2, retregs2, false);
        regconsave.used |= cg.regcon.used;
        cg.regcon = regconsave;
        assert(cg.stackpush == stackpushsave);
...
void cdmemcmp(ref CGstate cg,ref CodeBuilder cdb,elem* e,ref regm_t pretregs)
{
    ...
    */
    ...
    pretregs &= ~mPSW;
    fixresult(cg,cdb,e,retregsr,pretregs);
}
...
void cdmemcpy(ref CGstate cg, ref CodeBuilder cdb,elem* e,ref regm_t pretregs)
{
    ...
    tym_t ty2 = e2.E1.Ety;
    codelem(cg,cdb,e2.E1,retregs2,false);
    ...
    tym_t ty1 = e.E1.Ety;
    scodelem(cg,cdb,e.E1,retregs1,retregs2 | retregs3,false);
...
void cdmemset(ref CGstate cg, ref CodeBuilder cdb,elem* e,ref regm_t pretregs)
{
    ...
    codelem(cg,cdb,enumbytes,nbytesregs,false);
...
private void cdmemsetn(ref CGstate cg, ref CodeBuilder cdb,elem* e,ref regm_t pretregs)
{
    ...
    if (!cregs)
        cregs = cg.allregs;
    codelem(cg,cdb,enelems,cregs,false);
    ...
    regm_t vregs = cg.allregs & ~cregs;
    scodelem(cg,cdb,evalue,vregs,cregs,false);
    ...
    assert(dregs);
    scodelem(cg,cdb,e.E1,dregs,cregs | vregs,false);
    ...
    fixresult(cg,cdb,e,dregs,pretregs);
}
...
//                goto Lwin64;
        ...
        L2:
            ...
            else
            {
                uint sh = 0;
                uint base = 0;
                cs.Iop = INSTR.addsub_imm(1,0,0,sh,base,cg.BP,reg); // ADD reg,BP,base
                cs.IFL1 = fl;
                cs.IEV1.Vsym = e.Vsym;
                cs.IEV1.Voffset = 0;
                cdb.gen(&cs);
...
void cdpost(ref CGstate cg, ref CodeBuilder cdb,elem* e,ref regm_t pretregs)
{
    ...
    {
    /+    regm_t retregs = cg.allregs & ~idxregs & pretregs;
